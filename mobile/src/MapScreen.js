...
export default function MapScreen({ reports, onOpenReport }) {
  ...
  return (
    <View style={s.container}>
      <MapView ref={mapRef} style={s.map} initialRegion={INDIA} showsUserLocation>
        {reports.map(r => (
          <Marker
            key={r.id}
...
const s = StyleSheet.create({
  ...
  fab: {
    ...
    borderRadius: 28, paddingVertical: 13, paddingHorizontal: 22,
    gap: 6,
