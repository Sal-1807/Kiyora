...
export const SEED_REPORTS = [
  {
    ...
    image: null, timestamp: new Date(now - 2 * 3600000), address: 'Anna Salai, Chennai',
  },
  {
    ...
    image: null, timestamp: new Date(now - 4 * 3600000), address: 'T. Nagar Market, Chennai',
  },
  {
    ...
    image: null, timestamp: new Date(now - 26 * 3600000), address: 'Ambattur Industrial Area',
  },
  {
    id: 'r4', lat: 12.9762, lng: 77.6033,
    severity: 'high', status: 'Reported',
    description: 'Large pile of garbage dumped on the service road, blocking drainage.',
    image: null, timestamp: new Date(now - 3 * 3600000), address: 'MG Road, Bengaluru',
  },
  {
    ...
    image: null, timestamp: new Date(now - 5 * 3600000), address: 'Andheri West, Mumbai',
  },
  {
    ...
    image: null, timestamp: new Date(now - 6 * 3600000), address: 'Connaught Place, New Delhi',
  },
  {
    id: 'r7', lat: 22.5354, lng: 88.3506,
    severity: 'high', status: 'Reported',
    description: 'Open waste burning near residential buildings causing smoke and health hazard.',
    image: null, timestamp: new Date(now - 1 * 3600000), address: 'Park Street, Kolkata',
  },
];
